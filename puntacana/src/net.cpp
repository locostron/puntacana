...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "puntacana " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"puntacanatools.com", "148.0.243.64"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"puntacanatools.com", "testnet-seed.puntacanatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. puntacana is probably already running."), addrBind.ToString().c_str());
        else
